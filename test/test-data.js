...
module.exports = {
	...
	"popup.showHtml()": function (done) {
		_ele('divResult2').innerHTML =
			...
			"		'ccc4','ccc5','-','ccc6-sep','ccc7','ccc8','ccc9','ccc10','ccc11','ccc12','ccc13','ccc14'],{modal:_ele('chkModaless').checked,maxHeight:'15em'},function(err,data){if(err||data)alert('returned: error='+err+', data='+data);})\">selectButtonList()-2</button> " +
			"";
