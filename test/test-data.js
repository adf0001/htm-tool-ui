...
module.exports = {
	...
	"popup.show() & popup.hide()": function (done) {
		_ele('divResult2').innerHTML =
			...
			"<span class='ht-cmd' onclick=\"htm_tool_ui.popup.show('divPopup1',{dragMode:'first'})\">popup1</span> <br> " +
	...
	"popup.showHtml()": function (done) {
		_ele('divResult2').innerHTML =
			...
			"<button id='btnOpenPopup1' onclick=\"htm_tool_ui.popup.showHtml('title-1<hr>message-1',{modal:_ele('chkModaless').checked,})\">popup.showHtml()</button> " +
			...
			"<button id='btnOpenPopup3' onclick=\"htm_tool_ui.confirm('message-3 message-3 message-3 message-3',{modal:_ele('chkModaless').checked},function(err,data){if(err||data)alert('returned: error='+err+', data='+data);})\">confirm()-2</button> " +
			...
			"<button id='btnOpenPopupSelect2-3' onclick=\"htm_tool_ui.selectCheckboxList('select message 2',['aaa',['bbb','文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb '],'ccc','ccc2'," +
			"		'ccc3','ccc4','-','ccc5-sep','ccc6',null,'ccc7-skip null','ccc8','ccc9','ccc10','ccc11','ccc12','ccc13','ccc14'],['bbb','ccc'],_ele('chkModaless').checked,function(err,data){if(err||data)alert('returned: error='+err+', data='+data);})\">selectCheckboxList()-3</button> " +
			...
			"<button id='btnOpenPopupSelect2-5' onclick=\"htm_tool_ui.selectButtonList('select message 2',['aaa',['bbb','文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb 文本bbb '],'ccc',['ccc2','<div style=\\'color:red;text-align:left;\\'>ccc2</div>'],'ccc3'," +
