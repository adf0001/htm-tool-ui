...
//options: { modal, cb, cbThis, noDrag } | modal | cb
...
var show = function (el, options, cb) {
	...
	if (options.noDrag) {
		...
		if (!elBody.onmousedown) elBody.onmousedown = drag_object.startListener;
		if (!elBody.ontouchstart) elBody.ontouchstart = drag_object.startListener;
	}
