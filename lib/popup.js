...
//options: { modal, cb, cbThis } | modal | cb | noDrag
...
var show = function (el, options, cb) {
	...
	//drag handler
	//if user define any of onmousedown or ontouchstart, or noDrag, drag handler will not be installed.
	if (!options.noDrag && !elBody.onmousedown && !elBody.ontouchstart) {
